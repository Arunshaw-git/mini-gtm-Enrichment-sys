...
def enrich_company(domain: str) -> dict:
    ...
    try:
        ...
        return {
            "industry": data.get("NAICS industry group description"),
            "company_size": data.get("Number of employees range site specific"),
            "revenue_range": data.get("Yearly revenue range site specific"),
        }
